...
namespace HoloToolkit.Unity
{
    ...
    public class Tagalong : SimpleTagalong
    {
        ...
        protected override void Start()
        {
            ...
            // clipping plane.
            //如果指定的Tagalog的最小距离将在相机的近剪切平面内，调整为超过近剪切平面10%
            ...
            //如果MaintainFixedSize为真，则添加FixedAngularSize脚本
