...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class InteractionInputSource : BaseInputSource
    {
        ...
        private struct AxisButton2D
        {
            ...
            public static AxisButton2D GetThumbstick(UnityEngine.XR.WSA.Input.InteractionSourceState interactionSource)
            {
            ...
            public static AxisButton2D GetTouchpad(UnityEngine.XR.WSA.Input.InteractionSourceState interactionSource)
            {
                return new AxisButton2D
                {
#if UNITY_2017_2_OR_NEWER
        ...
        private struct TouchpadData
        {
            ...
            public static TouchpadData GetTouchpad(UnityEngine.XR.WSA.Input.InteractionSourceState interactionSource)
            {
        ...
        private struct AxisButton1D
        {
            ...
            public static AxisButton1D GetSelect(UnityEngine.XR.WSA.Input.InteractionSourceState interactionSource)
            {
        ...
        {
            public SourceData(UnityEngine.XR.WSA.Input.InteractionSource interactionSource)
            {
            ...
            public UnityEngine.XR.WSA.Input.InteractionSourceKind SourceKind { get { return Source.kind; } }
#if UNITY_2017_2_OR_NEWER
            public InteractionSourceHandedness Handedness { get { return Source.handedness; } }
#endif
            public readonly UnityEngine.XR.WSA.Input.InteractionSource Source;
        ...
        private void UpdateSourceData(UnityEngine.XR.WSA.Input.InteractionSourceState interactionSourceState, SourceData sourceData)
        {
        ...
        private void InteractionManager_InteractionSourceUpdated(UnityEngine.XR.WSA.Input.InteractionSourceState state)
        {
        ...
        private void InteractionManager_InteractionSourceReleased(UnityEngine.XR.WSA.Input.InteractionSourceState state)
        {
            InputManager.Instance.RaiseSourceUp(this, state.source.id, InteractionSourcePressInfo.Select);
        }

        private void InteractionManager_InteractionSourcePressed(UnityEngine.XR.WSA.Input.InteractionSourceState state)
        {
            InputManager.Instance.RaiseSourceDown(this, state.source.id, InteractionSourcePressInfo.Select);
        }

        private void InteractionManager_InteractionSourceLost(UnityEngine.XR.WSA.Input.InteractionSourceState state)
        {
            // NOTE: We don't care whether the source ID previously existed or not, so we blindly call Remove:
        ...
        private void InteractionManager_InteractionSourceDetected(UnityEngine.XR.WSA.Input.InteractionSourceState state)
        {
            // NOTE: We update the source state data, in case an app wants to query it on source detected.
        ...
        protected void GestureRecognizer_Tapped(UnityEngine.XR.WSA.Input.InteractionSourceKind source, int tapCount, Ray headRay)
        {
            InputManager.Instance.RaiseInputClicked(this, 0, InteractionSourcePressInfo.Select, tapCount);
        }

        protected void GestureRecognizer_HoldStarted(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Ray headray)
        {
            InputManager.Instance.RaiseHoldStarted(this, 0);
        }

        protected void GestureRecognizer_HoldCanceled(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Ray headray)
        {
            InputManager.Instance.RaiseHoldCanceled(this, 0);
        }

        protected void GestureRecognizer_HoldCompleted(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Ray headray)
        {
            InputManager.Instance.RaiseHoldCompleted(this, 0);
        }

        protected void GestureRecognizer_ManipulationStarted(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Vector3 cumulativeDelta, Ray headray)
        {
            InputManager.Instance.RaiseManipulationStarted(this, 0);
        }

        protected void GestureRecognizer_ManipulationUpdated(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Vector3 cumulativeDelta, Ray headray)
        {
            InputManager.Instance.RaiseManipulationUpdated(this, 0, cumulativeDelta);
        }

        protected void GestureRecognizer_ManipulationCompleted(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Vector3 cumulativeDelta, Ray headray)
        {
            InputManager.Instance.RaiseManipulationCompleted(this, 0, cumulativeDelta);
        }

        protected void GestureRecognizer_ManipulationCanceled(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Vector3 cumulativeDelta, Ray headray)
        {
            InputManager.Instance.RaiseManipulationCanceled(this, 0);
        }

        protected void NavigationGestureRecognizer_NavigationStarted(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Vector3 normalizedOffset, Ray headray)
        {
            InputManager.Instance.RaiseNavigationStarted(this, 0);
        }

        protected void NavigationGestureRecognizer_NavigationUpdated(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Vector3 normalizedOffset, Ray headray)
        {
            InputManager.Instance.RaiseNavigationUpdated(this, 0, normalizedOffset);
        }

        protected void NavigationGestureRecognizer_NavigationCompleted(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Vector3 normalizedOffset, Ray headray)
        {
            InputManager.Instance.RaiseNavigationCompleted(this, 0, normalizedOffset);
        }

        protected void NavigationGestureRecognizer_NavigationCanceled(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Vector3 normalizedOffset, Ray headray)
        {
